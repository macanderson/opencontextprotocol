---
title: "Implementing an Context Graph Protocol provider"
description: "How to implement an Context Graph Protocol provider in-process with Rust or over the language-neutral stdio and HTTP wire protocol."
---
...
[protocol-surface.md](./protocol-surface) — the wire payload is exactly
...
[running-conformance.md](./running-conformance) for that next step.
