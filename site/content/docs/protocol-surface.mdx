---
title: "Context Graph Protocol protocol surface"
description: "The normative Context Graph Protocol wire types, envelope framing, version grammar, schema, and conformance requirements."
---
...
See [`stability.md`](./stability) for what "draft" means and when it
freezes.
...
request/response. See [Implementing a provider](./implementing-a-provider)
...
See [`stability.md`](./stability) for the crate-version vs. protocol-version
