---
title: "The Open Context Protocol: A Technical Overview"
description: "An engineering overview of OCP, its seven guarantees, wire surface, scope, and current draft status."
---
