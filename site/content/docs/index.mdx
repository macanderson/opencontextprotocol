---
title: "OCP reference documentation"
description: "Reference documentation for the Open Context Protocol specification, implementations, and conformance tools."
---
...
- [**The Open Context Protocol: A Technical Overview**](./overview) — the
...
- [**The Open Context Protocol: Advantages and Uniqueness**](./protocol-advantages)
