---
title: "Implementing an OCP provider"
description: "How to implement an OCP provider in-process with Rust or over the language-neutral stdio and HTTP wire protocol."
---
