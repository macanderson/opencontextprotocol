---
title: "Running the Context Graph Protocol conformance suite"
description: "How to verify an Context Graph Protocol provider with the contextgraph-inspect CLI or the contextgraph-conformance Rust library."
---
