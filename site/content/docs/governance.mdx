---
title: "OCP governance"
description: "How OCP is maintained, how normative changes are decided, and the criteria for freezing the 1.0 protocol."
---
...
the work. See ["How OCP relates to MCP"](./overview).
