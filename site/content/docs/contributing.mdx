---
title: "Contributing to Open Context Protocol"
...
This project follows the [Code of Conduct](https://github.com/macanderson/opencontextprotocol/blob/main/CODE_OF_CONDUCT.md). By
